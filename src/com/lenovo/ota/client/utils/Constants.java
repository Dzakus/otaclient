package com.lenovo.ota.client.utils;
...
//	public static final String FilePath = "/data/data/com.lenovo.ota.client/lenovootadata/" ;
	...
	//DownloadReceiver
	public static final String DOWNLOAD_START = "com.lenovo.ota.client.download.start" ;
	public static final String DOWNLOAD_PAUSE = "com.lenovo.ota.client.download.pause" ;
	public static final String DOWNLOAD_STOP = "com.lenovo.ota.client.download.stop" ;
	
	//Clicking Notification starts to activity by Intent-action
	public static final String Intent_Bundle_Key_Notification = "com.lenovo.ota.client.intent.bundle.key.notification" ;
	public static final String Intent_Bundle_Value_Notification = "com.lenovo.ota.client.intent.bundle.value.notification" ;
